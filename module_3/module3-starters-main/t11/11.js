...
const close_icon = modal.querySelector('span');

for (let pic of picArray) {

  const newArticle = createArticle(pic);  // create the article
  document.getElementById('pictures').appendChild(newArticle);  // add it to the HTML

  newArticle.addEventListener('click', function(event) {
